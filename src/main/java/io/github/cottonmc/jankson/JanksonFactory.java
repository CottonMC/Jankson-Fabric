...
public class JanksonFactory {
	public static Jankson.Builder builder() {
		...
		register(builder, ComponentPredicate.Type.class,     Registries.DATA_COMPONENT_PREDICATE_TYPE);
		...
		register(builder, DebugSubscriptionType.class,       Registries.DEBUG_SUBSCRIPTION);
		register(builder, EntityAttribute.class,             Registries.ATTRIBUTE);
		register(builder, EntityType.class,                  Registries.ENTITY_TYPE);
		register(builder, EnvironmentAttribute.class,        Registries.ENVIRONMENTAL_ATTRIBUTE);
		register(builder, EnvironmentAttributeType.class,    Registries.ATTRIBUTE_TYPE);
		...
		register(builder, GameRule.class,                    Registries.GAME_RULE);
		register(builder, HeightProviderType.class,          Registries.HEIGHT_PROVIDER_TYPE);
		register(builder, IncomingRpcMethod.class,           Registries.INCOMING_RPC_METHOD);
		...
		register(builder, OutgoingRpcMethod.class,           Registries.OUTGOING_RPC_METHOD);
